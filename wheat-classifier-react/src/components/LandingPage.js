            ...
            <div className="container">
                <div className="row">
                    <h1 className="col-12 header">
                        Wheat Rust Classifier
                    </h1>
                </div>
                <div className="row">
                    <div className="col-12 message">
                        This wheat rust classifier can identify the following using the image of a wheat plant:
                        healthy wheat, stem rust and leaf rust.
